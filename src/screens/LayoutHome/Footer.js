...
class Footer extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                <div className="bg-dark text-white" id="footer" style={{marginTop:"80px"}}>
                        ...
                        <div className="row">
                            <div className="col-md-3">
                                <a href="" className="brand d-flex align-items-center mb-4">
                                    <span className="mr-2">
                                        {/* <!-- LOGO --> */}
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="24" height="24">
                            ...
                            <div className="col-md-9">
                                <div className="row">
                                    ...
                                    <div className="col-sm-6 col-md-3">
                                        <h5>Contact us</h5>
                                        <p className="text-light">Street Name, Suite 12<br /> Dublin, Ireland</p>

                                        <div className="d-flex ">

                                            <a href="https://www.facebook.com/platform.denizey" title="facebook" target="_blank" className="btn btn-facebook btn-rounded-social d-flex align-items-center justify-content-center mr-2"><i className="fab fa-facebook"></i></a>
                                            <a href="https://www.linkedin.com/company/denizey-platform" title="linkedin"  target="_blank" className="btn btn-twitter btn-rounded-social d-flex align-items-center justify-content-center mr-2"><i className="fab fa-linkedin"></i></a>
                                            <a href="https://www.instagram.com/denizeyplatform" target="_blank" title="instagram" className="btn btn-secondary btn-rounded-social d-flex align-items-center justify-content-center mr-2"><i className="fab fa-instagram-square"></i></a>
                                            <a href="https://t.me/denizeyplatform" target="_blank" title="telegram" className="btn btn-secondary btn-rounded-social d-flex align-items-center justify-content-center mr-2"><i className="fab fa-telegram-plane"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
