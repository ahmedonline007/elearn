                ...
                <div className="row">
                  ...
                  <div className="col-sm-6 col-md-3">
                    ...
                    <p className="text-light">
                      Street Name, Suite 12
                      <br /> Dublin, Ireland
                    </p>

                    <div className="d-flex ">
                      <a
                        href="https://www.facebook.com/platform.denizey"
                        title="facebook"
                        target="_blank"
                        className="btn btn-social btn-facebook btn-rounded-social d-flex align-items-center justify-content-center mr-2"
                      >
                        <i className="fab fa-facebook"></i>
                      </a>
                      <a
                        href="https://www.linkedin.com/company/denizey-platform"
                        title="linkedin"
                        target="_blank"
                        className="btn btn-social btn-twitter btn-rounded-social d-flex align-items-center justify-content-center mr-2"
                      >
                        <i className="fab fa-linkedin"></i>
                      </a>

                      <a
                        href="https://www.instagram.com/denizeyplatform"
                        title="instagram"
                        target="_blank"
                        className="btn btn-social btn-instagram btn-rounded-social d-flex align-items-center justify-content-center mr-2"
                      >
                        <i className="fab fa-instagram"></i>
                      </a>
                      <a
                        href="https://t.me/denizeyplatform"
                        title="telegram"
                        target="_blank"
                        className="btn btn-social btn-twitter btn-rounded-social d-flex align-items-center justify-content-center mr-2"
                      >
