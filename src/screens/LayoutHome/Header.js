                            ...
                            <div className="navbar navbar-secondary navbar-light navbar-expand-sm p-0 d-none d-md-flex" id="secondaryNavbar">
                                ...
                                <ul className="nav navbar-nav">
                                    ...
                                    {/* <li className="nav-item dropdown">
                                        <a href="" className="nav-link dropdown-toggle" data-toggle="dropdown">Layouts</a>
                                        <div className="dropdown-menu">
                                            <a className="dropdown-item" href="index.html">Admin</a>
                                            <a className="dropdown-item" href="fluid-index.html">Full Width</a>
                                            <a className="dropdown-item active" href="fixed-index.html">Fixed</a>
                                        </div>
                                    </li> */}
                                </ul>
                                <form className="form-inline my-2 my-lg-0 ml-auto" >
                                    <button className="btn btn-outline-primary my-2 my-sm-0" type="button" onClick={() => this.props.history.push("/Login")}>Login</button>
                                </form>
                            </div>
                        </div>
                    </div>
