...
export default function Login() {
    return (
        <div className="layout-login-centered-boxed">
            <div className="layout-login-centered-boxed__form">
                <div className="d-flex flex-column justify-content-center align-items-center mt-2 mb-4 navbar-light">
                    <a href="index.html" className="text-center text-light-gray mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 40 40" width="60" height="60">
                ...
                <div className="card card-body">
                    ...
                    <form action="index.html" novalidate>
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-group input-group-merge">
                                <input id="password_2" type="password" required="" className="form-control form-control-prepended" placeholder="Enter your password" />
                                <div className="input-group-prepend">
                                    <div className="input-group-text">
                        ...
                        <div className="form-group text-center mb-0">
                            <a href="">Forgot password?</a> <br />
                                        Don't have an account? <a className="text-underline" href="signup.html">Sign up</a>
                        </div>
                    </form>
                </div>
            </div>
